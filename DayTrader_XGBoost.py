...
plot_actual_vs_predicted(test_data)
...
plot_actual_vs_predicted(
    combined_results,
    title="Actual vs. Predicted Values Including Forecast",
)
...
plot_forecast_with_confidence(forecast_df)
...
plot_actual_vs_forecast(combined_results, forecast_confidence)
